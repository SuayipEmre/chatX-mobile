import {
  ...
  import { fetchUserProfile, updateProfile, uploadAvatar } from "../service/user.service";
    ...
    const handlePickImage = async () => {
      ...
      if (!result.canceled) {
        ...
        try {
          ...
          const imageUrl = await uploadAvatar(base64!); 
      ...
      <View className="flex-1 bg-black px-6 pt-16">        
        ...
        <TouchableOpacity
          ...
          className={`mt-10 py-4 rounded-2xl items-center ${
            saving || uploading ? "bg-neutral-700" : "bg-blue-600"
          }`}
        >
          {saving ? (
            <ActivityIndicator color="white" />
